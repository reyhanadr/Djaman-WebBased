                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                          ...
                          <td class="py-2">
                            <a target="_blank" href="<?php echo $data_kontak->maps?>">
                              <?= $data_kontak->maps ?>
                            </a>
                          </td>
                        </div>
                        ...
                        <div class="row">
                          <div class="mt-2">
                              <a href="<?= base_url()?>index.php/Kontak/editKontak/<?=  $data_kontak->id_kontak?>" class="btn btn-primary">Edit Kontak</a>
                              <a href="<?= base_url()?>index.php/Kontak/tampilKontak" class="btn btn-outline-primary">Kembali</a>
                          </div>
                        </div>
