...
>
  <head>
    ...
    <title>Data Kontak - Djaman Admin</title>
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <?php foreach ($data_kontak as $item) : ?>
                    <tbody class="table-border-bottom-0">
                      <tr>
                        <td><?php echo $item->id_kontak; ?></td>
                        <td><?php echo $item->alamat; ?></td>
                        <td><?php echo $item->phone; ?></td>
                        <td><?php echo $item->email; ?></td>
                        <td><?php echo $item->maps; ?></td>
                        ...
                        <td>
                          <a class="dropdown-item" href=" <?php echo site_url('Kontak/editKontak/'.$item->id_kontak); ?> "><i class="bx bx-edit-alt me-1"></i> Edit</a>
                        </td>
                      </tr>
                      <?php endforeach; ?>
                    </tbody>
