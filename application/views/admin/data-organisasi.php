...
>
  <head>
    ...
    <title>Data Organisasi - Djaman Admin</title>
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <?php
                    ...
                    $this->table->set_heading('Foto Anggota', 'ID Anggota', 'Nama Anggota', 'Jabatan', 'Email', 'Action');
                    
                    foreach ($data_organisasi as $item) {
                        $foto = '<img src="' . base_url('/assets/img/anggota/' . $item->foto) . '" alt="Avatar" class="avatar rounded-circle" />';
                        $edit_link = site_url('Organisasi/editOrganisasi/' . $item->id_anggota);
                        $action = '<a class="dropdown-item" href="' . $edit_link . '"><i class="bx bx-edit-alt"></i> Edit</a>';
